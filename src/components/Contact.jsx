      ...
      <div className="contact-info-container">
        <div className="contact-text">
          ...
          <p>
            ...
            Whether you need a landing page that converts, a real-time
            application, or a complete full-stack solution — let's talk.
          </p>
        </div>
        ...
        <div className="contact-card">
          ...
          <div className="contact-icon-container">
            <div className="icon-text">
              ...
              <a
                href="https://www.linkedin.com/in/abdiel-jeft%C3%A9-flores-gutierrez-468208325/"
                target="_blank"
